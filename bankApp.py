...
def login():
    ...
    if name1 == name and pin1 == pin:
        ...
        listmenu = ["1-Deposit","2-Withdraw","3-Transer","4-check Balance","5-Deposit interest rate","6-Calculate compound interest"]
        for b in listmenu:
            print(b)
        ...
        if choose == 1:
            ...
            if len(dest) ==8:
                ...
                print("The transaction has been rejected since the destination account is invalid")
                login()
        elif choose == 4:
            print("Your current balance is"+"" + str(cb))
        elif choose == 5:
